...
This project involved the following tasks:
 ...
 - Created a rolling calendar using Power Query M code
...
![Alt text](https://github.com/ankitabose97/Adventure-Work-Bike-Shop---Performance-Analysis/blob/main/Overview.png)
...
![Alt text](https://github.com/ankitabose97/Adventure-Work-Bike-Shop---Performance-Analysis/blob/main/Drillthrogh%20-%20Product.png)

Customer Detail View
 - total customer and per-customer revenue analysis

![Alt text](https://github.com/ankitabose97/Adventure-Work-Bike-Shop---Performance-Analysis/blob/main/Customer%20Analysis.png)
...
AI Visuals
 - Decomposition Tree to drill-down into profit  
 - Analysed by  category, gender, occupation to understand the root causes of high values
...
Solving this will help – 
 ...
 - Inventory Team - To plan stock refilling based on demand
